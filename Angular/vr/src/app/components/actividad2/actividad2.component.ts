...
export class Actividad2Component implements OnInit {
  ...
  constructor(private router:Router,
              ...
              private leccionesService:LeccionesService) { 
                ...
                this.actividadCompletada = this.validarLeccionCompletada(localStorage.getItem("actividad2completada"));
  ...
  start(){
    ...
    document.getElementById('pFrase').textContent = this.datos.act2[0];
  ...
  siguienteFrase(){
    ...
    if (this.indiceFrase == 8){
      ...
      localStorage.setItem("actividad2completada", "true");
      this.actividadCompletada = this.validarLeccionCompletada(localStorage.getItem("actividad2completada"));
    ...
    document.getElementById('pFrase').textContent = this.datos.act2[this.indiceFrase];
  }
